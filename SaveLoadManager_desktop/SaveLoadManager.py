...
def main():
    ...
    def window_game_new_func():
        ...
        def button_ok_func():
            if var_entry_game.get() == '':
                return
            SaveLoadManagerCore.game_new(var_entry_game.get(), var_entry_folder.get(), var_entry_file.get())
            game_list_init()
    ...
    def window_game_delete_func():
        ...
        def button_ok_func():
            SaveLoadManagerCore.game_delete(var_game.get())
            game_list_init()
            profile_list_init()
            save_list_init_without_comment()
    ...
    def window_profile_new_func():
        ...
        def button_ok_func():
            if var_entry_profile.get() == '':
                return
            SaveLoadManagerCore.profile_new(var_game.get(), var_entry_profile.get())
            profile_list_init()
    ...
    def window_profile_delete_func():
        ...
        def button_ok_func():
            SaveLoadManagerCore.profile_delete(var_game.get(), var_profile.get())
            profile_list_init()
            save_list_init_without_comment()
    ...
    def window_delete_func():
        ...
        def button_ok_func():
            SaveLoadManagerCore.save_delete(var_game.get(), var_profile.get(), var_save.get(), var_folder.get(), var_file.get())
    ...
    def save_func():
        if var_game.get() == '' or var_profile.get() == '':
            return
        SaveLoadManagerCore.save_new(var_game.get(), var_profile.get(), var_folder.get(), var_file.get(), var_comment.get())
        save_list_init_with_comment()
        root.update()
    ...
    button_save_load = tkinter.Button(grid_frame_save_load_delete, text="Load", command=lambda: SaveLoadManagerCore.save_load(var_game.get(), var_profile.get(), var_save.get(), var_folder.get(), var_file.get()), width=grid_frame_save_load_delete_width)
    ...
    def profile_list_init():
        (profile_list, folder, file) = SaveLoadManagerCore.profile_list_func(var_game.get())
    ...
    def save_list_init_without_comment():
        save_list = SaveLoadManagerCore.save_list_func(var_game.get(), var_profile.get())
    ...
    def save_list_init_with_comment():
        ...
        for save in save_list_no_comment[3:]:
            SaveLoadManagerCore.save_delete(var_game.get(), var_profile.get(), save, var_folder.get(), var_file.get())
